...
self.addEventListener("fetch",e=>{
  ...
  // Android Web Share Target posts shared text/images here.
    ...
    e.respondWith((async()=>{
      try{
        ...
        for(const [name,value] of fd.entries()){
          if(name==="files" && value instanceof File && value.size){
            image={
              name:value.name,
              type:value.type,
              blob:value
